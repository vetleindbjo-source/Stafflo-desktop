...
export function Sidebar() {
  const { activePage, setActivePage, settings, employees, authUser, backendAvailable } = useAppStore()
      ...
      <div className="px-5 py-4 border-t border-white/10">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-white/40 text-xs">{tr('employees_count', employees.length)}</span>
          </div>
          {authUser && (
